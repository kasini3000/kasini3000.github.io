...
* openEuler 22.03 LTS SP4 及以上。openEuler 24.03 LTS sp2及以上。

* rocky linux 10.1 及以上。rocky linux 9.6 及以上。8.10 及以上。

* alma linux 10.1 及以上。alma linux 9.6 及以上。8.10 及以上。
...
6.0 
目的：
从 https://github.com/kasini3000/k4t2_dns_x64_win_test
下载win版etcd，coredns，traefik
...
mkdir k4t
cd k4t
git clone  https://github.com/kasini3000/k4t2_dns_x64_win_test.git   --branch main --depth=1 --single-branch --verbose
```

6.1 win上启动etcd
```
c:\ProgramData\k4t\etcd_3.6\d单机，http，无认证.ps1
```
...
c:\ProgramData\k4t\traefik_3.5\traefik.toml 

6.10.4 运行win版traefik：
```
c:\ProgramData\k4t\traefik_3.5\y1有dashboard，无监视目录，有etcd.ps1
```
